...
const (
	...
	ErrDelimiterInStringLiteralDoesntMatch                 Error = 17 // Deprecated: Error removed from the server
	ErrCannotInsertElementIntoConstantColumn               Error = 18 // Deprecated: Error removed from the server
	ErrSizeOfFixedStringDoesntMatch                        Error = 19
	ErrNumberOfColumnsDoesntMatch                          Error = 20
	ErrCannotReadAllDataFromTabSeparatedInput              Error = 21 // Deprecated: Error removed from the server
	ErrCannotParseAllValueFromTabSeparatedInput            Error = 22 // Deprecated: Error removed from the server
	...
	ErrCannotPrintInteger                                  Error = 29 // Deprecated: Error removed from the server
	ErrCannotReadSizeOfCompressedChunk                     Error = 30 // Deprecated: Error removed from the server
	ErrCannotReadCompressedChunk                           Error = 31 // Deprecated: Error removed from the server
	...
	ErrIllegalNumberOfResultColumns                        Error = 45 // Deprecated: Error removed from the server
	...
	ErrStorageDoesntAllowParameters                        Error = 54 // Deprecated: Error removed from the server
	...
	ErrOnlyFilterColumnInBlock                             Error = 61 // Deprecated: Error removed from the server
	ErrSyntaxError                                         Error = 62
	ErrUnknownAggregateFunction                            Error = 63
	ErrCannotReadAggregateFunctionFromText                 Error = 64 // Deprecated: Error removed from the server
	ErrCannotWriteAggregateFunctionAsText                  Error = 65 // Deprecated: Error removed from the server
	ErrNotAColumn                                          Error = 66 // Deprecated: Error removed from the server
	ErrIllegalKeyOfAggregation                             Error = 67 // Deprecated: Error removed from the server
	...
	ErrCannotReadAllDataFromChunkedInput                   Error = 97 // Deprecated: Error removed from the server
	ErrCannotWriteToEmptyBlockOutputStream                 Error = 98 // Deprecated: Error removed from the server
	...
	ErrReceivedDataForWrongQueryID                         Error = 103 // Deprecated: Error removed from the server
	ErrTooSmallBufferSize                                  Error = 104
	ErrCannotReadHistory                                   Error = 105 // Deprecated: Error removed from the server
	ErrCannotAppendHistory                                 Error = 106 // Deprecated: Error removed from the server
	...
	ErrCannotGetReturnType                                 Error = 126 // Deprecated: Error removed from the server
	...
	ErrCannotCreateTableFromMetadata                       Error = 132 // Deprecated: Error removed from the server
	...
	ErrAllRequestedColumnsAreMissing                       Error = 140 // Deprecated: Error removed from the server
	ErrSamplingNotSupported                                Error = 141
	ErrNotFoundNode                                        Error = 142
	ErrFoundMoreThanOneNode                                Error = 143 // Deprecated: Error removed from the server
	ErrFirstDateIsBiggerThanLastDate                       Error = 144 // Deprecated: Error removed from the server
	ErrUnknownOverflowMode                                 Error = 145
	ErrQuerySectionDoesntMakeSense                         Error = 146 // Deprecated: Error removed from the server
	ErrNotFoundFunctionElementForAggregate                 Error = 147 // Deprecated: Error removed from the server
	ErrNotFoundRelationElementForCondition                 Error = 148 // Deprecated: Error removed from the server
	ErrNotFoundRHSElementForCondition                      Error = 149 // Deprecated: Error removed from the server
	ErrNoAttributesListed                                  Error = 150 // Deprecated: Error removed from the server
	ErrIndexOfColumnInSortClauseIsOutOfRange               Error = 151 // Deprecated: Error removed from the server
	ErrUnknownDirectionOfSorting                           Error = 152
	ErrIllegalDivision                                     Error = 153
	ErrAggregateFunctionNotApplicable                      Error = 154 // Deprecated: Error removed from the server
	ErrUnknownRelation                                     Error = 155 // Deprecated: Error removed from the server
	ErrDictionariesWasNotLoaded                            Error = 156
	ErrIllegalOverflowMode                                 Error = 157 // Deprecated: Error removed from the server
	...
	ErrTooDeepPipeline                                     Error = 163 // Deprecated: Error removed from the server
	...
	ErrBadGet                                              Error = 170
	ErrBlocksHaveDifferentStructure                        Error = 171 // Deprecated: Error removed from the server
	ErrCannotCreateDirectory                               Error = 172
	ErrCannotAllocateMemory                                Error = 173
	ErrCyclicAliases                                       Error = 174
	ErrChunkNotFound                                       Error = 176 // Deprecated: Error removed from the server
	ErrDuplicateChunkName                                  Error = 177 // Deprecated: Error removed from the server
	ErrMultipleAliasesForExpression                        Error = 178 // Deprecated: Error removed from the server
	...
	ErrUnsupportedMyisamBlockType                          Error = 185 // Deprecated: Error removed from the server
	ErrUnsupportedCollationLocale                          Error = 186
	ErrCollationComparisonFailed                           Error = 187
	ErrUnknownAction                                       Error = 188 // Deprecated: Error removed from the server
	ErrTableMustNotBeCreatedManually                       Error = 189 // Deprecated: Error removed from the server
	...
	ErrServerRevisionIsTooOld                              Error = 197 // Deprecated: Error removed from the server
	ErrDNSError                                            Error = 198
	ErrUnknownQuota                                        Error = 199
	ErrQuotaDoesntAllowKeys                                Error = 200 // Deprecated: Error removed from the server
	...
	ErrNestedTypeTooDeep                                   Error = 205 // Deprecated: Error removed from the server
	...
	ErrAddingReplicaToNonEmptyTable                        Error = 222 // Deprecated: Error removed from the server
	...
	ErrIncorrectMark                                       Error = 247 // Deprecated: Error removed from the server
	ErrInvalidPartitionValue                               Error = 248
	ErrNotEnoughBlockNumbers                               Error = 250 // Deprecated: Error removed from the server
	...
	ErrStorageDoesntSupportParallelReplicas                Error = 267 // Deprecated: Error removed from the server
	ErrCPUIDError                                          Error = 268 // Deprecated: Error removed from the server
	...
	ErrLeadershipLost                                      Error = 278 // Deprecated: Error removed from the server
	...
	ErrLeadershipChanged                                   Error = 292 // Deprecated: Error removed from the server
	...
	ErrNoRemoteShardFound                                  Error = 296 // Deprecated: Error removed from the server
	...
	ErrInvalidShardWeight                                  Error = 317 // Deprecated: Error removed from the server
	ErrInvalidConfigParameter                              Error = 318
	ErrUnknownStatusOfInsert                               Error = 319
	ErrValueIsOutOfRangeOfDataType                         Error = 321
	ErrBarrierTimeout                                      Error = 335 // Deprecated: Error removed from the server
	ErrUnknownDatabaseEngine                               Error = 336
	ErrDdlGuardIsActive                                    Error = 337 // Deprecated: Error removed from the server
	...
	ErrIncompatibleSourceTables                            Error = 350 // Deprecated: Error removed from the server
	ErrAmbiguousTableName                                  Error = 351 // Deprecated: Error removed from the server
	...
	ErrBadLambda                                           Error = 356 // Deprecated: Error removed from the server
	ErrReservedIdentifierName                              Error = 357 // Deprecated: Error removed from the server
	...
	ErrOutputIsNotSorted                                   Error = 365 // Deprecated: Error removed from the server
	ErrSizesOfNestedColumnsAreInconsistent                 Error = 366
	ErrTooManyFetches                                      Error = 367 // Deprecated: Error removed from the server
	ErrBadCast                                             Error = 368 // Deprecated: Error removed from the server
	...
	ErrUnknownStatusOfDistributedDdlTask                   Error = 379 // Deprecated: Error removed from the server
	...
	ErrConditionalTreeParentNotFound                       Error = 2001 // Deprecated: Error removed from the server
	ErrIllegalProjectionManipulator                        Error = 2002 // Deprecated: Error removed from the server
)
