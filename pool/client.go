...
import (
	...
	"github.com/hanzo-ds/native"
)

// Client is an acquired *native.Client from a Pool.
type Client struct {
...
func (c *Client) Do(ctx context.Context, q native.Query) (err error) {
...
func (c *Client) client() *native.Client {
